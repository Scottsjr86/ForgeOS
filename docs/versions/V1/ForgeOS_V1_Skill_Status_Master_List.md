...
>
> Source basis: `Forge_OS_V1_base_23.tar`, the canonical V1 skill tree, and the live session results through `FORGEOS-V1-PARSER-100`.
> `FORGEOS-V1-LSP-100` is currently active and awaiting operator validation.
...
**Raw closed-node count:** 14 of 67, or 20.9%. This is not a release-completion percentage because higher-tier nodes integrate many lower-tier capabilities.
...
| 1 | Local mechanisms | 16 | closed 4, active 1, available 8, locked 3 |
...
- **Immediate unlock after closure:** None by itself. `EDITOR-201` also requires `EDITOR-200`.
...
| 🔨 ACTIVE | `FORGEOS-V1-LSP-100` | Rust Analyzer process and JSON-RPC adapter | ✅ `FORGEOS-V1-CONTRACT-000`<br>✅ `FORGEOS-V1-PROCESS-000`<br>✅ `FORGEOS-V1-GUARD-002` |
