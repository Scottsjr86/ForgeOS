...
ACTIVE_QUESTION=Can ForgeOS validate and register a versioned project manifest against a real repository boundary?
...
RETURN_PATH=CLOSE_ONLY_FORGEOS-V1-PROJECT-100_THEN_REEVALUATE_PROJECT-200_AND_CURRENT_AVAILABLE_FRONTIER
