...
ACTIVE_QUESTION=Can ForgeOS run one project-bound Rust Analyzer JSON-RPC session without crossing document generations or project boundaries?
...
RETURN_PATH=CLOSE_ONLY_FORGEOS-V1-LSP-100_THEN_REEVALUATE_CURRENT_AVAILABLE_FRONTIER
