...
ACTIVE_QUESTION=Can ForgeOS assign stable domain-separated SHA-256 identities over declared canonical bytes?
...
RETURN_PATH=CLOSE_ONLY_FORGEOS-V1-HASH-000_THEN_REEVALUATE_ITS_DIRECT_UNLOCKS_AND_CURRENT_AVAILABLE_FRONTIER
```
