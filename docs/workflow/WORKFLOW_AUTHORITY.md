...
ACTIVE_QUESTION=Can ForgeOS enforce the declared authority direction across every reviewed subsystem package and reject unknown ForgeOS workspace crates, backward dependencies, and transitive adapter smuggling through the real Cargo graph?
...
RETURN_PATH=CLOSE_ONLY_FORGEOS-V1-GUARD-002_THEN_REEVALUATE_ITS_DIRECT_UNLOCKS_AND_CURRENT_AVAILABLE_FOUNDATIONS
```
