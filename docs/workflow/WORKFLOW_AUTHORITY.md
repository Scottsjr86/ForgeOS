...
ACTIVE_QUESTION=Can ForgeOS restore dirty editor bytes and truthful non-live terminal and Nyx service metadata after a controlled crash without replaying interrupted work?
...
SOURCE_IMPLEMENTATION_ALLOWED=YES_FOR_DECLARED_RECOVERY_PATHS_ONLY
CURRENT_RESULT=NYX_LOCAL_CONVERSATION_CLOSED_DURABLE_WORKSPACE_RECOVERY_ACTIVE
RETURN_PATH=RUN_FORGE_BEHAVIOR_CI_AND_RETURN_EXACT_COMMAND_SUMMARIES
