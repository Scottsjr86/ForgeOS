...
ACTIVE_QUESTION=Can ForgeOS run one real stable-identity PTY session with exact raw byte I/O, resize, exit status, and explicit isolated termination?
...
RETURN_PATH=CLOSE_ONLY_FORGEOS-V1-TERMINAL-100_THEN_REEVALUATE_CURRENT_AVAILABLE_FRONTIER
