...
ACTIVE_QUESTION=Can ForgeOS persist canonical local state atomically under explicit schemas and recover without silent reset?
...
RETURN_PATH=CLOSE_ONLY_FORGEOS-V1-STATE-000_THEN_REEVALUATE_PROJECT_FILE_AND_CURRENT_AVAILABLE_FRONTIER
```
