...
ACTIVE_QUESTION=Can ForgeOS preserve stable repository identity while resolving real canonical paths and rejecting path-boundary escapes?
...
RETURN_PATH=CLOSE_ONLY_FORGEOS-V1-PATH-000_THEN_REEVALUATE_ITS_DIRECT_UNLOCKS_AND_CURRENT_AVAILABLE_FRONTIER
```
