...
ACTIVE_QUESTION=Can ForgeOS stage, unstage, commit, explicitly confirmed restore, create a linked worktree, and remove a clean linked worktree through typed exact requests without shell prose, force flags, ambiguous pathspecs, or hidden repository crossing?
...
RETURN_PATH=CLOSE_ONLY_FORGEOS-V1-GIT-101_THEN_REEVALUATE_CURRENT_AVAILABLE_FRONTIER
