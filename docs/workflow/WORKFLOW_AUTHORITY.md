...
ACTIVE_QUESTION=Can ForgeOS define one immutable registered command with stable identity, exact argv, repository-bound working directory, clear-parent declared environment, timeout, cancellation, authority class, and an inspectable shell-free launch payload?
...
RETURN_PATH=CLOSE_ONLY_FORGEOS-V1-COMMAND-100_THEN_REEVALUATE_CURRENT_AVAILABLE_FRONTIER
