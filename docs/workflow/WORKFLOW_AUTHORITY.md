...
ACTIVE_QUESTION=Can ForgeOS maintain one canonical buffer authority per repository document with explicit dirty and conflict state while leaving disk mutation to forge-project?
...
RETURN_PATH=CLOSE_ONLY_FORGEOS-V1-EDITOR-100_THEN_REEVALUATE_CURRENT_AVAILABLE_FRONTIER
